...
for i = 1:length(SalMap)
    SalMap{i} = normalize(SalMap{i})./255;
end
...
%some researcher use the following definition
%AP = trapz([0,MeanRecall,1],[1,MeanPrec,0]); 
%AUC = trapz([0,MeanFP,1],[1,MeanRecall,0]);
